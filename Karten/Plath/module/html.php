...
//=========================
function pageHeader($title,$lang)
{
    return '
<!DOCTYPE html>
<html lang="en">
  ...
  <!-- hidden behind the navbar. Used by JS getUserLanguage() to set/get the user language-->
';
}
...
//=========================
function pageNavigation($label, $map, $aboutUs, $languageButton, $lang)
{
    return '
    <!-- Fixed navbar -->
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="index.php?lang='.$lang.'">'.$map.'</a></li>
            <li><a href="about.php?lang='.$lang.'">'.$aboutUs.'</a></li>
          </ul>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="index.php?lang=de"><span class="flag-icon flag-icon-de"></span> Deutsch</a></li>
...
function displaySearchResponse() {
  return '
...
{
    return '
    <!-- display Map and sidebar -->
      <div class="row">
        <div class="col-md-9">
             <div id="map"></div>
        </div>
        <!-- Sidebar Information for places -->
...
function pageCategories($menuCategories, $categoriesContent, $standardCatOne, $standardCatTwo)
{
    return '
      <div class="row">
        ...
        <div class="col-md-12">
             <div class="thumbnail">
	       <!-- Start a Tab list. Details siehe http://holdirbootstrap.de/komponenten/#nav -->
                <ul role="tablist" class="nav nav-tabs" id="myTab">
		  <!-- Zwei hart kodierte Kategorien - alles und nichts. -->
		  ...
		  <!-- Aus der Datenbasis ausgelesene Kategorien. -->
                    '.$menuCategories.'
                </ul>
