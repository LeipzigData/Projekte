 ...
 */
    ...
    var map;
    var JSONFile = "../data/rdf/jugendstadtplan.json";
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i in data) {
                    ...
                    // if this is jsp:Ort
                    if (typeof (data[i][rdfType]) == "undefined") console.log("rdfType not set");
                    else {
                        if (data[i][rdfType][0].value == "http://leipzig-data.de/Data/Jugendstadtplan/Ort") {
                            ...
                            if (data[i][hasAddress] != null) {
                                ...
                                //Geo-Coordinates:
                                if (typeof (data[address]) == "undefined") console.log(jsp_URI[testcounter] + " Address Resource not exists :" + address);
                                else {
                                    ...
                                    if (typeof (data[address][geoLat]) == "undefined") console.log(jsp_URI[testcounter] + " Adress Ressource without GEODATA :" + address);
                                        ...
                                        if (typeof lat != "undefined") {
                                            ...
                                            if (typeof (data[i][rdfLabel]) == "undefined") console.log(jsp_URI[testcounter] + "RDF Label non-existent");
                                                ...
                                                addLocation(jsp_uri, data[i][rdfLabel][0].value, lat, lng, getUserLanguage());
                                            }
                                        }
                                    }
                                }
...
// init map with all available locations
allLocations(true);
